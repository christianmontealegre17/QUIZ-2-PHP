    ...
    <body>
        ...
        <table class="table table-sm">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td><?php echo $producto[$record]['nombre'] ?></td>
                        <td><?php echo $producto[$record]['tipo_postre'] ?></td>
                        <td><?php echo $producto[$record]['tipo_bizcocho'] ?></td>
                        <td>
                            <a href="editar_producto.php?gato_user=<?php echo $producto[$record]['id_producto'] ?>">
                                <button class="btn btn-warning">Editar</button>
                            </a>
                        </td>
                        <td>
                        <td>
                            <a href="eliminar_producto.php?michi_user=<?php echo $producto[$record]['id_producto'] ?>">
