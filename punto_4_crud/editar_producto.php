        ...
        <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="poste_form_user" class="form-control" id="poste_form_user" value="<?php echo $producto['tipo_postre'] ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="bizco_form_user">Tipo bizcocho</label>
                <input type="text" class="form-control" id="bizco_form_user" name="bizco_form_user" value="<?php echo $producto['tipo_bizcocho'] ?>">
            </div>
